...
En el camp de la recerca, el final d'un treball pot ser l'inici d'un nou projecte de recerca. Per això crec convenient fer propostes de com es podria continuar la meva recerca. Tot i que aquest projecte ja ofereix una eina funcional per integrar dades de Bicing i AMBici, una línia clara de continuació seria el desenvolupament d’una aplicació mòbil. Aquesta app permetria tenir tot el sistema al teu abast: consultar estacions pròximes, veure si hi ha bicicletes o espais disponibles, detectar punts de transbord i rebre recomanacions en temps real. Seria una manera de fer que el projecte fos encara més accessible i útil per a l’usuari final.
