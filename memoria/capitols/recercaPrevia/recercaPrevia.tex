...
Un altre avantatge de Python és que el seu codi es pot llegir amb facilitat, fins i tot per persones que no són expertes. Això facilita molt la creació del codi (programa) i poder explicar el seu funcionament.

\section{Mobilitat sostenible}
La part final de la recerca prèvia va consistir en contextualitzar la importància d’aquest tema. El transport privat que consumeix benzina és una de les principals fonts de contaminació a les ciutats, i serveis com el Bicing contribueixen a reduir emissions i fomentar hàbits saludables.
...
Aquesta fundació treballa per sensibilitzar la ciutadania, oferir formació i impulsar l’ús responsable de la gran quantitat d’informació que les administracions fan pública.

En el meu projecte, he intentat seguir aquesta filosofia: utilitzar les dades amb respecte, documentar el procés amb claredat, i compartir els resultats de manera oberta perquè altres persones puguin aprendre, reutilitzar o millorar el meu treball.
...
\begin{table}[htbp]
\centering
\begin{tabular}{|p{4cm}|p{3.9cm}|p{3.8cm}|p{3.5cm}|}
\hline
