...
Les dades que s’obtenen de l’API del Bicing es presenten en \textbf{format JSON}, unes sigles que volen dir \textit{JavaScript Object Notation}. Aquest format és com una llista de parelles \emph{clau–valor}. Per exemple, una estació pot aparèixer així:
