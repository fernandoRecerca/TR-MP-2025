...
El punt de partida d’aquest treball és la problemàtica detectada a la zona de la \textbf{Riera Blanca}, on les xarxes de bicicleta compartida \textbf{Bicing} i \textbf{AMBici} es troben molt a prop però no estan connectades. Davant d’aquesta situació, el repte plantejat ha estat dissenyar una eina capaç de facilitar el transbord entre serveis i oferir una visió integrada de les dues plataformes.
