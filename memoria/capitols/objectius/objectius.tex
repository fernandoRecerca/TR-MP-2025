...
\begin{enumerate}
 \item Requisits proposats pel Tutor
    \begin{enumerate}
        ...
        El projecte havia de dur-se a terme amb eines pròpies de l’àmbit acadèmic i de recerca: ús del sistema operatiu Linux, control de versions amb \texttt{git}, redacció amb \LaTeX\ i repositori públic a GitHub. Aquest enfocament s’explica amb més detall al capítol~\ref{c:metodologia}:~\nameref{c:metodologia}.
        ...
        Tot el treball ha estat elaborat amb una llicència de codi lliure que permet a qualsevol usuari la llibertat per utilitzar i modificar el codi font dels programes i de la memòria.
